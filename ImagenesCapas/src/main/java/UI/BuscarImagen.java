 ...
 * @author meza4
 */
public class BuscarImagen extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NodoListaDoble nodo = Controlador.listaimagenes.buscar(jTextField1.getText());
        if(nodo!=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarImagen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarImagen().setVisible(true);
            }
        });
    }
